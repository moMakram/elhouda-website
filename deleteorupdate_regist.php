...
<table width="650" border="0" style="text-align:center; margin-left:50px; margin-top:40px;">
  <tr style="background:#999; height:35px;">
    ...
    <td><font face="Comic Sans MS, cursive"  color="#000000">الاسم الاول</font></td>
	<td><font face="Comic Sans MS, cursive"  color="#000000">الاسم الاخير</font></td>
	<td><font face="Comic Sans MS, cursive"  color="#000000">الموبايل</font></td>
	<td><font face="Comic Sans MS, cursive"  color="#000000">الايميل</font></td>
	<td><font face="Comic Sans MS, cursive"  color="#000000">كلمة السر</font></td>
  ...
  <tr style="background:#03C;height:30px;">
	...
	<td>');  echo (' <a href="delete_regist.php?id= '); echo $row['id']; echo('"> <font color="white"> delete </font></a></td>
  </tr> '); } 
