  ...
  <table width="480" height="150" border="0" bordercolor="#000" style="margin-left:144px; margin-top:30px;">
   ...
   <tr>
    ...
    <tr>
	  ...
	  <tr>
      <td width="150" style="background:#000" align="center"><font color="#FFFFFF" face="Comic Sans MS, cursive">الظهور</font></td>
      <td style="background-color:#060">
	  
	   <select name="show" style=" border:none;margin-left:6px; margin-top:2px; width:307px; height:20px;"/>
	  <option>يظهر</option>
	  <option>لايظهر</option>
	  </select>
	  </td>
    </tr>
...
$show= $_POST['show'];
  ...
  $result = mysql_query("INSERT INTO video (pic,name,ordere,showe)
 values('$dir','$name','$ordere','$show' )");
 echo "<br />";
if ($result){
echo ("inserted");
echo("<br>");
