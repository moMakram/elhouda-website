...
<table width="650" border="0" style="text-align:center; margin-left:50px; margin-top:40px;">
  <tr style="background:#999; height:35px;">
	...
	<td><font face="Comic Sans MS, cursive"  color="#000000">السؤال</font></td>
  ...
  ');
	 $sel = mysql_query("select * from question  ");
  ...
  <tr style="background:#03C;height:30px;">
	...
	<td>'); echo $row['que']; echo('</td>
	<td>');  echo (' <a href="delete_question.php?id= '); echo $row['id']; echo('"> <font color="white"> delete </font></a></td>
  </tr> '); } 
