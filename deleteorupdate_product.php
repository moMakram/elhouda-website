...
<table width="700" border="0" style="text-align:center; margin-left:50px; margin-top:40px;">
  ...
  <tr style="background:#03C;height:30px;">
	...
	<td>');  echo (' <a href="update_product.php?id= '); echo $row['id']; echo('"> <font color="white"> update </font></a></td>
	<td>');  echo (' <a href="delete_product.php?id= '); echo $row['id']; echo('"> <font color="white"> delete </font></a></td>
  </tr> '); } 
